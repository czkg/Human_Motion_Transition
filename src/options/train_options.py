...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--lr_d', type=float, default=0.0002, help='initial learning rate for discriminator')
        ...
        # lambda parameters
        parser.add_argument('--lambda_BCE', type=float, default=10.0, help='weight for |B-G(A, E(B))|')
        parser.add_argument('--lambda_BCE_decoder', type=float, default=10.0, help='weight for |B-G(A, E(B))|')
        parser.add_argument('--lambda_GAN', type=float, default=1.0, help='weight on D loss. D(G(A, E(B)))')
        parser.add_argument('--lambda_consistency', type=float, default=1.0, help='weight for consistency loss')
        parser.add_argument('--lambda_bone', type=float, default=1.0, help='weight for bone length')
        parser.add_argument('--lambda_keyposes', type=float, default=1.0, help='weight for key poses')
